...
void	ft_map_editor_paint_parameter_texture(variable_list* l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l, l->pen_texture, l->me.str);
...
void	ft_map_editor_paint_parameter_group(variable_list* l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l, l->pen_group, l->me.str);
	l->u.str_address = l->me.str;
	l->u.wsx += 0.5;
	l->u.size = 0.80;
	l->u.colors = l->me.color_white;
...
void	ft_map_editor_paint_parameter_opacity(variable_list* l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l, l->pen_opacity, l->me.str);
	l->u.str_address = l->me.str;
	l->u.wsx += 0.5;
	l->u.size = 0.80;
	l->u.colors = l->me.color_white;
...
void	ft_map_editor_paint_parameter_light(variable_list* l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l, l->pen_light, l->me.str);
	l->u.str_address = l->me.str;
	l->u.wsx += 0.5;
	l->u.size = 0.80;
	l->u.colors = l->me.color_white;
