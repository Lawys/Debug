...
void	ft_initialize_variables(variable_list* l)
{
	...
	while (++i < 50)
	{
		...
		l->t.x1[l->triangle_number] = -99999;
		l->t.y1[l->triangle_number] = 99999;
		l->t.z1[l->triangle_number] = -99999;
		l->t.x2[l->triangle_number] = -99999;
		l->t.y2[l->triangle_number] = 99999;
		l->t.z2[l->triangle_number] = 99999;
		l->t.x3[l->triangle_number] = 99999;
		l->t.y3[l->triangle_number] = 99999;
		l->t.z3[l->triangle_number] = -99999;
		l->t.texture_id[l->triangle_number] = 43;
		l->t.texture_size_x[l->triangle_number] = 0.05;
		l->t.texture_size_y[l->triangle_number] = 0.05;
...
void	ft_read_all(variable_list* l)
{
	...
	ft_bmp_reader(l, "./img/img43.bmp");
	ft_bmp_reader(l, "./img/img44.bmp");
	ft_bmp_reader(l, "./img/img45.bmp");
	ft_bmp_reader(l, "./img/img46.bmp");
	ft_bmp_reader(l, "./img/img47.bmp");
	ft_bmp_reader(l, "./img/img48.bmp");
}
