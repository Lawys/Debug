...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   editor_interface_parameters_paint_1.c              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lparis <lparis@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/21 23:27:34 by mofikrat          #+#    #+#             */
/*   Updated: 2021/02/22 10:14:27 by lparis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_map_editor_paint_parameter_texture(variable_list *l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l->pe.pen_texture, l->me.str);
...
void		ft_map_editor_paint_parameter_group(variable_list *l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l->pe.pen_group, l->me.str);
	l->u.str_address = l->me.str;
	l->u.wsx += 0.5;
	l->u.size = 0.80;
	l->u.colors = l->me.color_white;
...
void		ft_map_editor_paint_parameter_area(variable_list *l)
{
	...
	l->u.colors_on = l->me.color_green;
	ft_put_text(l);
	ft_itoa(l->pe.pen_area, l->me.str);
	l->u.str_address = l->me.str;
	l->u.wsx += 0.5;
	l->u.size = 0.80;
	l->u.colors = l->me.color_white;
