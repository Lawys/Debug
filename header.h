...
/*   Updated: 2021/02/21 23:30:42 by mofikrat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_value_editing_double_set_negativ(variable_list* l, double* value, int* limits);
...
void		ft_value_editing_int_remove_number(variable_list* l, int* value, int* limits, int i);
void		ft_value_editing_int_set_negativ(variable_list* l, int* value, int* limits);
